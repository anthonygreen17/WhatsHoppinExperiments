defmodule ExperimentTwoWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ExperimentTwoWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/experiment_two_web/templates",
                        namespace: ExperimentTwoWeb
